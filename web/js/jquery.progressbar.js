	...
	$.extend({
		progressBar: new function() {
			...
			this.defaults = {
				...
				width			: 89,											// Width of the progressbar - don't forget to adjust your image too!!!												// Image to use in the progressbar. Can be a single image too: 'images/progressbg_green.gif'
				...
				barImage		: {
									0:	'../images/progressbg_grey.gif',
									30: '../images/progressbg_grey.gif',
									70: '../images/progressbg_grey.gif'
									100: '../images/.gif'
								},

	...
	try {
	   ...
	   var urlType = baseURL.toLowerCase().match(urlString);
		...
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
			...
			TB_WIDTH = 767; //defaults to 630 if no paramaters were added to URL
...
$("#TB_window").css({ width: TB_WIDTH + 'px'});//marginLeft: '-' + parseInt((TB_WIDTH / 2),10) + 'px', va dans les ({})
	if ( !(jQuery.browser.msie && jQuery.browser.version < 7)) { // take away IE6
		$("#TB_window").css({});// marginTop: '-' + parseInt((TB_HEIGHT / 2),10) + 'px' va dans les ({})
	}
}

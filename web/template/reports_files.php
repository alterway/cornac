...
<div id="page_interieur">
   ...
   <div id="scrollingDiv">
	<div id="colonne">
    	<a id="displayBloc" class="deroule nom_fichier" href="#"><span class="nom">Analyzer : <?php echo $analyzer; ?></span><span class="roulement"></span></a>
...
foreach($rows as $id => $row) {
    $html .= <<<HTML
                        <tr>
                            <td class="fichier">{$row['file']}</td>
                            <td class="color2 center">{$row['line']}</td>
                            <td class="color3 center">{$row['element']}</td>
